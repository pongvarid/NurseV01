                        ...
                        <v-card-text>
                            ...
                            <div v-for="course in courses">
                                <v-list-tile avatar @click="goto_coursePage(JSON.parse(course.courseData)[0].id)">
                                    ...
                                    <v-list-tile-content>
                                        <v-list-tile-title>@{{JSON.parse(course.courseData)[0].name.split(',')[1]}} [@{{JSON.parse(course.courseData)[0].code}}]</v-list-tile-title>
                                        <v-list-tile-title>(@{{JSON.parse(course.courseData)[0].name.split(',')[2]}}) </v-list-tile-title>
