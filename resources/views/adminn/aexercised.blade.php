...
methods: { 
  getDataFromApi () {
    ...
    deleteData(id){
        ...
        if(confirms){
            axios
      .delete("<?=env('link');?>/api/admined/"+id)
    ...
    updateData(){
        console.log();
        axios
      .put("<?=env('link');?>/api/admined/"+this.dataDB.id,this.dataDB)
      .then(function(response) {
    ...
    saveData(){
        axios
      .post("<?=env('link');?>/api/admined",this.dataDB)
      .then(function(response) {
      ...
      load(){
        let result =  axios.get('<?=env('link');?>/api/admined/1')
      .then((r) => {
          this.tmp = r.data;  
      }).catch((e) => { 
          alert('error');
